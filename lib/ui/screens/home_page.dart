...
class HomePage extends GetView<HomePageController> {
    ...
    return Obx(() {
      return Container(
          ...
          margin: EdgeInsets.only(
              right: Get.width * 0.03, bottom: Get.width * 0.22),
          ...
          child: Row(
            ...
            children: [
              ...
              InkWell(
                onTap: () => controller.swapDestination(),
                child: Container(
  ...
  Widget _homeBottomComponent() {
    return Container(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.center,
        mainAxisSize: MainAxisSize.min,
        children: [_detailsInfo(), _serchButton()],
      ),
    );
  }
    ...
    return Obx(() {
      return Container(
        child: Column(children: [
          ...
          Container(
            decoration: BoxDecoration(
                border: Border.all(width: 1, color: AppColors.hintTextColor)),
            child: Row(
              mainAxisAlignment: MainAxisAlignment.spaceBetween,
              children: [
                Obx(() {
                      ...
                      decoration: BoxDecoration(
                          border: const Border(
                              right: BorderSide(
                                  width: 1, color: AppColors.hintTextColor))),
                      padding: EdgeInsets.only(
                          top: Get.width * 0.03, left: Get.width * 0.05),
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          Text(
                          ...
                          Padding(
                            padding:
                                EdgeInsets.only(bottom: Get.height * 0.012),
                            child: Text(
                            ...
                            child: Padding(
                              ...
                              child: Row(
                                children: [
                                  ...
                                  Text(
                                    controller.adultNo.value.toString(),
                                    style: AppConstants.lightTextStyle(
                                        fontSize: 13,
                                        color: AppColors.primaryAppColor),
                                  ),
                                  ...
                                  Text(
                                    controller.tinegeNo.value.toString(),
                                    style: AppConstants.lightTextStyle(
                                        fontSize: 13,
                                        color: AppColors.primaryAppColor),
                                  ),
                                  ...
                                  Text(
                                    controller.babyNo.value.toString(),
                                    style: AppConstants.lightTextStyle(
                                        fontSize: 13,
                                        color: AppColors.primaryAppColor),
                                  ),
  ...
  _serchButton() {
    return Padding(
        ...
        child: Container(
          padding:
              EdgeInsets.symmetric(vertical: 20, horizontal: Get.width * 0.1),
          decoration: BoxDecoration(
